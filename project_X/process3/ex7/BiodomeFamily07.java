...
public class BiodomeFamily07 {
    public static void main(String[] args) {
        /*
        새로운 노래 "초원을 그리며, 2분, 레이나, 사슴" 추가되었습니다.
새로운 노래 "영웅 호테, 1분, 돈키, 당나귀" 추가되었습니다.
새로운 노래 "과자를 줄게, 3분, 제롬, 코끼리" 추가되었습니다.
새로운 노래 "화양연화, 2분, 장양림, 재즈" 추가되었습니다.
새로운 노래 "시간의 수평선, 4분, 하윤, 팝" 추가되었습니다.

"화양연화, 2분, 장양림, 재즈" 재생합니다.
볼륨을 30으로 설정합니다.
볼륨을 5로 설정합니다.
"영웅 호테, 1분, 돈키, 당나귀" 재생합니다.

노래 "시간의 수평선, 4분, 하윤, 팝" 삭제되었습니다.
         */
